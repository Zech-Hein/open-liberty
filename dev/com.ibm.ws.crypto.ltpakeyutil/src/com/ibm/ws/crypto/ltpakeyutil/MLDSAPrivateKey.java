 ...
 * This class encapsulates the private key used for signing LTPA tokens with quantum-resistant
 * cryptography.
 * 
...
public final class MLDSAPrivateKey implements PrivateKey {
    ...
    /**
     * Constructs an ML-DSA private key.
     * 
     ...
     */
    public MLDSAPrivateKey(byte[][] rawKey, String algorithm, int securityLevel) {
    ...
    public String toString() {
        return "MLDSAPrivateKey[algorithm=" + algorithm + ", securityLevel=" + securityLevel + "]";
    }
}
