...
public class PasswordUtil {
    ...
    /**
     * <p>
     * Constant that holds the name of the property for specifying the version for the AES encryption format.
     * </p>
     **/
     ...
     */
    public static String encode(String decoded_string) throws InvalidPasswordEncodingException, UnsupportedCryptoAlgorithmException, UnsupportedCryptoAlgorithmVersionException {
    ...
    public static String encode(String decoded_string,
                                String crypto_algorithm) throws InvalidPasswordEncodingException, UnsupportedCryptoAlgorithmException, UnsupportedCryptoAlgorithmVersionException {
    ...
    public static String encode(String decoded_string, String crypto_algorithm,
                                String crypto_key) throws InvalidPasswordEncodingException, UnsupportedCryptoAlgorithmException {
     ...
     * @throws UnsupportedCryptoAlgorithmVersionException
     */
    public static String passwordEncode(String decoded_string) throws UnsupportedCryptoAlgorithmVersionException {
     ...
     * @throws UnsupportedCryptoAlgorithmVersionException
     */
    public static String passwordEncode(String decoded_string, String crypto_algorithm) throws UnsupportedCryptoAlgorithmVersionException {
        /*
         * check input:
         *
         * -- decoded_string: any string, any length, cannot be null,
