 ...
 */
public class WSKrb5LoginModule extends ServerCommonLoginModule implements LoginModule {

    private static final TraceComponent tc = Tr.register(WSKrb5LoginModule.class, TraceConstants.TRACE_GROUP, TraceConstants.MESSAGE_BUNDLE);
...
//    }
     ...
     * (non-Javadoc)
     *
     * @see com.ibm.ws.security.authentication.internal.jaas.modules.ServerCommonLoginModule#getRequiredCallbacks(javax.security.auth.callback.CallbackHandler)
     */
    @Override
    public Callback[] getRequiredCallbacks(CallbackHandler callbackHandler) throws IOException, UnsupportedCallbackException {
