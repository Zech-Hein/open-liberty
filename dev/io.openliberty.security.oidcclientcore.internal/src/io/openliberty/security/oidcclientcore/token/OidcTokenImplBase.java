...
public class OidcTokenImplBase {
    private static final TraceComponent tc = Tr.register(OidcTokenImplBase.class);
    ...
    //TODO temp fix for AccessToken expiration values
    public final long expiresIn;

    public OidcTokenImplBase(JwtClaims jwtClaims, String access_token, String refresh_token, String client_id, String tokenTypeNoSpace, Long expiresIn) {
        this.jwtClaims = jwtClaims;
        this.access_token = access_token;
        this.refresh_token = refresh_token;
        this.client_id = client_id;
        if (tokenTypeNoSpace == null) {
            tokenTypeNoSpace = "IDToken"; //Constants.TOKEN_TYPE_ID_TOKEN;
